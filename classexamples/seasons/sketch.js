...
// var i = 0 start point
// i <100 conditional, how many times will loop will run`
//i++ which is same as saying i=i+1

  for(var i = 0; i<snowAmount; i++){
    snowX[i] = random(0,width); //random number is from 0- 399
...
function draw() {
  ...
  for(var y = 0; y<snowAmount; y++){
    snowY[y]++; //same as snowY[y]+1 for more speed +5
